...
button_export_path = Button(canvas.master, text="SAVE PATH", command=to_export, bg=DARK_GREY,
                            font=("Arial", 12, "bold"))
...
abort_mission = Button(canvas.master, text="EMERGENCY", command=fly.abort_mission, bg=DARK_GREY,
                       font=("Arial", 12, "bold"))
abort_mission.pack()
